...
const TOS = () => {
	return (
		<div className="container px-8 m-auto mb-20 mt-14 xl:mt-0 xl:py-24 xl:px-40">
			<h1 className="text-4xl font-bold">Terms of service</h1>
			<hr></hr>
			<div className="mt-6">
				<p>
					The Seasons List website located at www.seasonslist.com is a copyrighted work belonging to Seasons
					List. Certain features of the Site may be subject to additional guidelines, terms, or rules, which
				...
				<h2 className="mt-2 text-xl font-semibold">Access to the Site</h2>
				...
				<p>
					<strong>No Support or Maintenance.</strong> You agree that Company will have no obligation to
				...
				<h2 className="mt-2 text-xl font-semibold">Third-Party Links & Ads; Other Users</h2>
				...
				<p>
					...
					is a dispute between you and any Site user, we are under no obligation to become involved.
				</p>
				...
				<p>
					<strong>Cookies and Web Beacons.</strong> Like any other website, Seasons List uses cookies. These
				...
				<h2 className="mt-2 text-xl font-semibold">Disclaimers</h2>
				...
				<h2 className="mt-2 text-xl font-semibold">Limitation on Liability</h2>
				...
				<p>
					<strong>Term and Termination.</strong> Subject to this Section, these Terms will remain in full
					force and effect while you use the Site. We may suspend or terminate your rights to use the Site at
				...
				<h2 className="mt-2 text-xl font-semibold">Copyright Policy.</h2>
				...
				<h2 className="mt-2 text-xl font-semibold">General</h2>
				...
				<p>
					...
					be sent to: Seasons List. After the Notice is received, you and the Company may attempt to resolve
					the claim or dispute informally. If you and the Company do not resolve the claim or dispute within
					thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The
					amount of any settlement offer made by any party may not be disclosed to the arbitrator until after
				...
				<p>
					...
					the rights and liabilities of you and the Company, and the dispute will not be consolidated with any
				...
				<p>
					<strong>Entire Terms.</strong> These Terms constitute the entire agreement between you and us
				...
				<h2 className="mt-2 text-xl font-semibold">Contact Information</h2>

				<p>Address: Seasons List</p>
				<p>Email: jonathanfernandezfm@gmail.com</p>
			</div>
		</div>
	);
};
