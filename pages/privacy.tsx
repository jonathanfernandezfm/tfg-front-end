...
const Privacy = () => {
	return (
		<div className="container px-8 m-auto mb-20 mt-14 xl:mt-0 xl:py-24 xl:px-40">
			...
			<div className="mt-6">
				<p>
					At Seasons List, accessible from www.seasonslist.com, one of our main priorities is the privacy of
					our visitors. This Privacy Policy document contains types of information that is collected and
					recorded by Seasons List and how we use it.
				</p>
				...
				<p>
					...
					with regards to the information that they shared and/or collect in Seasons List. This policy is not
				...
				<h2 className="mt-2 text-xl font-semibold">Consent</h2>

				<p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

				<h2 className="mt-2 text-xl font-semibold">Information we collect</h2>
				...
				<h2 className="mt-2 text-xl font-semibold">How we use your information</h2>
				...
				<h2 className="mt-2 text-xl font-semibold">Log Files</h2>

				<p>
					Seasons List follows a standard procedure of using log files. These files log visitors when they
				...
				<h2 className="mt-2 text-xl font-semibold">Cookies and Web Beacons</h2>

				<p>
					Like any other website, Seasons List uses 'cookies'. These cookies are used to store information
				...
				<h2 className="mt-2 text-xl font-semibold">Advertising Partners Privacy Policies</h2>

				<p>
					You may consult this list to find the Privacy Policy for each of the advertising partners of Seasons
					List.
				</p>

				<p>
					Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
					that are used in their respective advertisements and links that appear on Seasons List, which are
				...
				<p>
					Note that Seasons List has no access to or control over these cookies that are used by third-party
					advertisers.
				</p>

				<h2 className="mt-2 text-xl font-semibold">Third Party Privacy Policies</h2>

				<p>
					Seasons List's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
				...
				<h2 className="mt-2 text-xl font-semibold">GDPR Data Protection Rights</h2>
				...
				<h2 className="mt-2 text-xl font-semibold">Children's Information</h2>
				...
				<p>
					Seasons List does not knowingly collect any Personal Identifiable Information from children under
